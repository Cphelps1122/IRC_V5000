...
if not unmapped_df.empty:
    panel_start("Unmapped Properties", "These properties were not placed on the map because their address could not be geocoded exactly. Add Latitude and Longitude columns for perfect placement.")
    unmapped = unmapped_df.copy()
    unmapped["Address"] = unmapped["Address"].fillna("")
    compact_table(unmapped, ["Property", "Street", "City", "State", "Zip", "Address", "Geocode Status"], max_rows=12)
    panel_end()
