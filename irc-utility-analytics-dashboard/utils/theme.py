    ...
    for _, r in alerts.head(max_cards).iterrows():
        ...
        st.markdown(
            ...
            <div class="alert-card">
              ...
              <div class="mini-grid">
                <div class="mini-stat"><div class="mini-label">Current Cost</div><div class="mini-value">{_fmt_money_html(current_cost)}</div></div>
                <div class="mini-stat"><div class="mini-label">Cost Δ</div><div class="mini-value">{_fmt_pct_html(cost_chg)}</div></div>
                <div class="mini-stat"><div class="mini-label">Usage Δ</div><div class="mini-value">{_fmt_pct_html(usage_chg)}</div></div>
                <div class="mini-stat"><div class="mini-label">Cost/Treatment Δ</div><div class="mini-value">{_fmt_pct_html(cpt_chg)}</div></div>
              </div>
              <div class="mini-grid">
                <div class="mini-stat"><div class="mini-label">Cost/Treatment</div><div class="mini-value">{_fmt_money_html(current_cpt, 2)}</div></div>
                <div class="mini-stat"><div class="mini-label">Est. Impact</div><div class="mini-value">{_fmt_money_html(impact)}</div></div>
