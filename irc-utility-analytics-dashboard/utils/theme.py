...
def alert_cards(alerts: pd.DataFrame, max_cards: int = 12):
    ...
    for _, r in alerts.head(max_cards).iterrows():
        ...
        if is_missing:
            ...
            metric_3_label = "Latest Cost/Treatment"
            metric_3_value = _fmt_money_html(r.get("Previous Cost/Treatment"), 2)
            metric_4_label = "Latest Cost/Usage"
            metric_4_value = _fmt_money_html(r.get("Previous Cost/Usage"), 2)
            ...
            metric_2_label = "Cost Δ"
            metric_2_value = _fmt_pct_html(cost_chg)
            metric_3_label = "Usage Δ"
            metric_3_value = _fmt_pct_html(usage_chg)
            metric_4_label = "Cost/Treatment Δ"
            metric_4_value = _fmt_pct_html(cpt_chg)
            metric_5_label = "Cost/Treatment"
            metric_5_value = _fmt_money_html(current_cpt, 2)
            metric_6_label = "Current Usage"
            metric_6_value = _fmt_num_html(current_usage)
